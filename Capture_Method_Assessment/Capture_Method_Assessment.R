...
dat %>% count(result == "Translocated") # 98
...
write_csv(translocated_summary,                     # Export table
          "translocated_management_counts.csv")     # Output file name
...
# Write results to CSV
write_csv(translocated_summary_pct,                 # export table with %
